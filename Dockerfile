...
RUN wget -nv https://github.com/cdr/code-server/releases/download/2.1662-vsc1.39.2/code-server2.1662-vsc1.39.2-linux-x86_64.tar.gz -O /tmp/vs-code-server.tar.gz && \
