...
The *stack* distribution of ShinyStudio introduces two additional requirements:
...
The *stack* distribution of ShinyStudio is delivered through the [GitHub repo](https://github.com/dm3ll3n/ShinyStudio).
