---
title: ShinyStudio
subtitle: 'A Docker orchestration of open-source solutions to facilitate secure, collaborative development.'
output:
  html_document:
    self_contained: true
    fig_caption: no
...
Complete the setup using either the provided scripts or by executing the commands manually. Once complete, open a web browser and navigate to
`http://<hostname>:8080`.
