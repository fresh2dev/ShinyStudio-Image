...
The [GitHub repo for ShinyStudio](https://github.com/dm3ll3n/ShinyStudio) contains two major branches: `base` and `master`.
...
* The bind mount for `application.yml` specifies a custom ShinyProxy configuration file ([read more here](https://www.shinyproxy.io/configuration/)).
...
For a more out-of-the-box setup, consider cloning/forking the [master branch](https://github.com/dm3ll3n/ShinyStudio/tree/master) from GitHub. e.g.,
